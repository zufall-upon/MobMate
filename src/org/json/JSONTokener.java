...
public class JSONTokener {
    ...
    private int nextCleanInternal() throws JSONException {
        final int inLength = this.in.length();
        while (this.pos < inLength) {
            ...
            case '#':
                /*
                 * Skip a # hash end-of-line comment. The JSON RFC doesn't specify this behavior,
    ...
    private void skipToEndOfLine() {
        final int inLength = this.in.length();
        for (; this.pos < inLength; this.pos++) {
    ...
    private char readEscapeCharacter() throws JSONException {
        ...
        case 'u':
            ...
            try {
                ...
                throw new JSONException("Invalid escape sequence: " + hex);
            }
        case 't':
            return '\t';
        case 'b':
    ...
    private Object readLiteral() throws JSONException {
        ...
        if (literal.length() == 0) {
            throw new JSONException("Expected literal value");
        ...
        /* ...next try to parse as a BigDecimal... */
        try {
        ...
        while (true) {
            ...
            if (!(name instanceof String)) {
                if (name == null) {
                    ...
                    throw new JSONException("Names must be strings, but " + name + " is of type " + name.getClass().getName());
                }
            }
            /*
            ...
            if (this.pos < inLength && this.in.charAt(this.pos) == '>') {
                this.pos++;
            }
